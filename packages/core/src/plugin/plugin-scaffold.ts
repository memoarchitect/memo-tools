...
function generatePluginSource(id: string, name: string, type: PluginType): string {
    switch (type) {
        case 'export':
            return `import type { ExportPlugin, PluginContext, ExportResult } from '@memo/core';
import type { DhfDocument } from '@memo/core';
...
`;
        ...
        case 'analysis':
            return `import type { AnalysisPlugin, PluginContext, AnalysisResult } from '@memo/core';
...
`;
        ...
        case 'validation':
            return `import type { ValidationPlugin, PluginContext } from '@memo/core';
import type { Violation } from '@memo/core';
...
`;
        ...
        case 'generator':
            return `import type { GeneratorPlugin, PluginContext } from '@memo/core';
